...
//				System.out.println(file.getName() + ": " + str);
				...
				// fügt alle IDs, die in irgendwelchen Dateien im Pfad gefunden wurden zur
				// MetadatensatzTabelle hinzu
				if (MetadatensatzTable.insertIdIntoDatabase(id)) {
					++insg;
					System.out.println(
							insg + ") " + file.getName() + " #" + (i + 1) + " ID = '" + id + "' war noch nicht drin");
					...
					try {// speichert das aber nur ab, wenn es eine gültige Json ist. z.B. weil Datensatz
						...
						System.err.println(
								"Fehler beim Verarbeiten von id '" + str + "'. Antwort wird nicht gespeichert.");
						continue;
					}
