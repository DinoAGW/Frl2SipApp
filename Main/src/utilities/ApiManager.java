...
public class ApiManager {
	...
	/*
	 * ruft den Datensatz zu einer bestimmten ID über resource ab (das nötigenfalls
	 * auch mit Zugangsdaten ApiAccount) und speichert diese im Cache
	 */
	public static void saveId2File(String id) throws Exception {
		...
		try {
			...
			System.err.println("Fehler beim Verarbeiten des Datensatzes '" + id + "'. Versuche API Account");
	...
	public static void saveDataOfId2File(String id, String file) throws Exception {
		...
		String command = "curl -u " + user + ":" + passwort + " --ssl-no-revoke https://frl.publisso.de/resource/frl:"
				+ id + "/data --output " + file;
